...
/obj/item/reagent_containers/food/snacks/fish/attack_self(mob/M)
	...
	showoffer = M
	M.visible_message("[M] shows off [M.p_their()] [src]. It's [length] inches long and weights [weight] ounces!", \
						 span_notice("You show off your [src]. It's [length] inches long and weigths [weight] ounces!"))
